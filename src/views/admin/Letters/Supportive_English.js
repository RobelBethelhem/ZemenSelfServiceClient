              ...
              <CForm>
                <CContainer fluid className="p-0" style={{ 
                  ...
                  <div style={{ textAlign: 'justify', marginBottom: '1rem' }}>
                    የባንካችን ሠራተኛ የሆኑት አቶ/ወይ <strong>{full_name}</strong> ለተቋማችሁ የደመወዛቸው መጠንና ቋሚ ሠራተኛ 
                    መሆናቸው ተገልጾ መረጃ እንዲፃፍላቸው {request_day_amharic} በተፃፈ ማመልከቻ ጠይቀዋል፡፡
                  </div>
