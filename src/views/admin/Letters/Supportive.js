...
//   var employee_organazation = rowData.employee_organazation;
...
//       pdf.save(`${full_name}_Supportive_Letter.pdf`);
//     });
//   };
...
//                       <div className="d-flex align-items-center">
//                           <span className="me-2 text-nowrap fw-bold">ለ </span>
//                           <span className="fw-bold">{employee_organazation} </span>
...
//                       <span className="spaced spaced_left">ለተቋማችሁ</span>
...
//                       <span className="spaced">እንዲፃፍላቸው</span>
//                       {request_day_amharic}
...
//                       <span className="spaced">እንገልጻለን</span>
//                       <span className="spaced">፡፡</span>
//                     </FlexItem>
//                   </FlexContainer>

//                   {/* Sincerely and Signature */}
//                   <div className="mt-4 mb-5 fw-bold">
//                   ከሰላምታ ጋር,
//                   </div>
...
// export default Supportive_Letter;
...
const Supportive_Letter = () => {
  ...
  const { gate, ratingModal } = useServiceRatingGate({
    rowData,
    requestType: 'Supportive',
    letterLabel: 'Supportive Letter',
  });
                  ...
                  <div className="d-flex flex-column align-items-end mb-4" style={{marginLeft: '20px', marginRight: '20px'}}>
                    <div className="d-flex justify-content-end w-100">
                      <div className="d-flex align-items-center">
                        ...
                        <span className="fw-bold">{new Date(rowData.viewed_date).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })} G.C</span> 
                      </div>
                    </div>
                    <div className="d-flex justify-content-end w-100">
                      <div className="d-flex align-items-center">
                   ...
                   <div className="d-flex flex-column mb-4" style={{marginLeft: '20px', marginRight: '20px'}}> 
                      <div className="d-flex w-100">
                      <div className="d-flex align-items-center">
                          <span className="me-2 text-nowrap fw-bold">To: </span>
                          <span className="fw-bold">{employee_organazation}</span>
                      </div>
                      </div>
                      <div className="d-flex w-100">
                      <div className="d-flex align-items-center">
                          <span className="me-2 text-nowrap"></span>
                          <span className="fw-bold text-decoration-underline">{employee_organization_location}</span>
                      </div>
                      </div>
                  </div>

                  <div className="text-left fw-bold mb-4">
                      Subject: <span className="text-decoration-underline">Employment Confirmation for Ato/Wro. {full_name}</span>
                  </div>

                  {/* Certification Body - Fixed text flow */}
                  <div style={{ textAlign: 'justify', marginBottom: '1rem', marginLeft: '20px', marginRight: '20px' }}>
                    Ato/Wro. <strong>{full_name}</strong>, an employee of our bank, with application
                    dated {new Date(rowData.request_day_english).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })} G.C, has requested us to write a letter of confirmation of his employment.
                  </div>

                  <div style={{ textAlign: 'justify', marginBottom: '1rem', marginLeft: '20px', marginRight: '20px' }}>
                  Accordingly, we hereby certify that Ato/Wro. <strong>{full_name}</strong> has been employed with
                  our bank on a permanent basis since {new Date(rowData.date_of_employment_english).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })} G.C. As of the date of this letter, his
                  gross monthly salary is <strong>Birr</strong> <strong>{Number(salary).toLocaleString('en-US', { maximumFractionDigits: 0 })}</strong> (<strong style={{textTransform: 'capitalize'}}>{salary_in_words}</strong>).
                  </div>

                  <div style={{ textAlign: 'justify', marginBottom: '1rem', marginLeft: '20px', marginRight: '20px' }}>
                  Please note that all applicable income tax and pension contributions are being deducted
                  regularly and remitted to the appropriate government authorities in accordance with the
