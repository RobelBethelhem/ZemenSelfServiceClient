...
const Supportive_Letter = () => {
  ...
  var approved_day_amharic = rowData.approved_day_amharic;
  var salary = rowData.salary;
  var employmentDate = rowData.date_of_employment_amharic;
                ...
                <CContainer fluid className="p-0" style={{ 
                  ...
                  <div className="d-flex flex-column align-items-end mb-4" style={{marginLeft: '20px', marginRight: '20px'}}>
                    <div className="d-flex justify-content-end w-100">
                      <div className="d-flex align-items-center">
                        <span className="me-2 text-nowrap fw-bold">ቀን:</span>
                        <span className="fw-bold">{rowData.approved_day_amharic}</span> 
                      </div>
                    </div>
                    <div className="d-flex justify-content-end w-100">
                      <div className="d-flex align-items-center">
                  ...
                  <div className="d-flex flex-column mb-4" style={{marginLeft: '20px', marginRight: '20px'}}>
                   ...
                   <div className="text-center fw-bold mb-4">
                      ጉዳዩ:- <span className="text-decoration-underline">መረጃ ስለመስጠት፣</span>
                  </div>

                  {/* Certification Body - Fixed text flow */}
                  <div style={{ textAlign: 'justify', marginBottom: '1rem', marginLeft: '20px', marginRight: '20px' }}>
                    የባንካችን ሠራተኛ የሆኑት አቶ/ወይ <strong>{full_name}</strong> የባንከችን ቋሚ ሠራተኛ መሆናቸው፣ ተገልጾ የድጋፍ ደብዳቤ እንዲፃፍላቸው {request_day_amharic} በተፃፈ 
                    ማመልከቻ ጠይቀዋል፡፡ 
                  </div>

                  <div style={{ textAlign: 'justify', marginBottom: '1rem', marginLeft: '20px', marginRight: '20px' }}>
                    ስለሆነም አቶ/ወይ <strong>{full_name}</strong> {employmentDate} ጀምሮ በባንካችን ውስጥ በቋሚነት ተቀጥረው በመስራት ላይ የሚገኙ ሲሆን፤
                     የሚከፈላቸውም ያልጣራ የወር ደመወዝ 
                     ብር <strong>{Number(salary).toLocaleString('en-US', { maximumFractionDigits: 0 })}</strong> / <strong>{salary_in_words}</strong> / 
                    መሆኑን እናረጋግጣለን፡፡
                  </div>

                  <div style={{ textAlign: 'justify', marginBottom: '1rem', marginLeft: '20px', marginRight: '20px' }}>
                  ከተጠቃሽ የወር ደመወዝ ተገቢው የስራ ግብርና የጡረታ መዋጮ በየወሩ እየተቆረጠ
                  ለሚመለከተው የመንግስት አካል ገቢ እየተደረገ መሆኑን እየገልፅን፤ ለሚደረግላቸው ትብብር 
                  እናመሰግናለን፡፡
                  </div>
