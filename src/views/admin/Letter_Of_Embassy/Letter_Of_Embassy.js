    ...
    >
      <CCard className="mb-4 shadow-lg">
        <CCardHeader className="bg-primary text-white">
          <InfiniteScrollText text="Zemen Bank Letter For Embassy Request Form" />
        </CCardHeader>
        <CCardBody>
          ...
          >
            <CForm onSubmit={handleSubmit} ref={formRef}>
              ...
              <AnimatedFormGroup delay={delayIncrement += 0.1}>
                <CFormLabel htmlFor="employee_embassy_name">Embassy Name</CFormLabel>
                <motion.div variants={inputVariants} whileFocus="focus" whileBlur="blur">
                  <CFormInput
                    type="text"
                    id="employee_embassy_name"
                    value={formData.employee_embassy_name}
                    onChange={handleInputChange}
              ...
              <AnimatedFormGroup delay={delayIncrement += 0.1}>
                ...
                <motion.div variants={inputVariants} whileFocus="focus" whileBlur="blur">
                  <CFormTextarea
                    ...
                    onChange={handleInputChange}
                    placeholder="Short Description if so (Optional)"
                    className="shadow-sm"
                  />
                </motion.div>
              </AnimatedFormGroup>
...
export default EmbassyLetterForm;
